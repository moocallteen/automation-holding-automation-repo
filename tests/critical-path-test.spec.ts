...
test("QA Form critical path test", async ({ page }) => {
  await page.getByText('This is a non-functional demo').click();
  await expect(page.getByText('This is a non-functional demo')).toBeVisible();
  await page.getByText('By using this demo, you agree').click();
  await expect(page.getByText('By using this demo, you agree')).toBeVisible();
